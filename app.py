...
config_path = os.path.join(local_dir, "ControlNetModel/config.json")
if not os.path.exists(config_path):
    hf_hub_download(repo_id="InstantX/InstantID", filename="ControlNetModel/config.json", local_dir=local_dir)

model_path = os.path.join(local_dir, "ControlNetModel/diffusion_pytorch_model.safetensors")
...
adapter_path = os.path.join(local_dir, "ip-adapter.bin")
...
5. Share your customizd photo with your friends, enjoyðŸ˜Š!
"""
